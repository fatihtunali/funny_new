            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex items-center space-x-4 text-sm text-gray-600 mb-4">
                  <span>📍 {Array.isArray(pkg.destinations) ? pkg.destinations.join(', ') : pkg.destinations}</span>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <ul className="space-y-2">
                  {(Array.isArray(pkg.included) ? pkg.included : [pkg.included]).map((item: string, index: number) => (
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <ul className="space-y-2">
                  {(Array.isArray(pkg.notIncluded) ? pkg.notIncluded : [pkg.notIncluded]).map((item: string, index: number) => (
                    <li key={index} className="flex items-start text-gray-700">
