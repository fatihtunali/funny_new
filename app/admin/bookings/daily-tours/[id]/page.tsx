...
import { FaArrowLeft, FaUser, FaEnvelope, FaPhone, FaCalendar, FaUsers, FaMapMarkerAlt, FaTag } from 'react-icons/fa';
import LogoutButton from '@/components/admin/LogoutButton';
import DailyTourBookingActions from '@/components/admin/DailyTourBookingActions';

export default async function AdminDailyTourBookingDetailPage({ params }: { params: Promise<{ id: string }> }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <h1 className="ml-6 text-2xl font-bold text-gray-900">Daily Tour Booking Details</h1>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b pb-3">
                  ...
                  <span className="text-lg font-bold text-teal-600">{booking.referenceNumber}</span>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900">{booking.guestName || 'Guest'}</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-lg font-bold text-gray-900">{booking.tour.title}</p>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900">{booking.tour.tourCode}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900">{booking.numberOfPax} {booking.numberOfPax === 1 ? 'Person' : 'People'}</p>
                  </div>
                </div>

                {booking.tourType && (
                  <div>
                    <p className="text-xs text-gray-500 mb-1">Tour Type</p>
                    <span className={`px-3 py-1 text-sm font-semibold rounded-full ${
                      booking.tourType === 'SIC'
                        ? 'bg-blue-100 text-blue-800'
                        : 'bg-purple-100 text-purple-800'
                    }`}>
                      {booking.tourType === 'SIC' ? 'Shared Tour (SIC)' : 'Private Tour'}
                    </span>
                  </div>
                )}
