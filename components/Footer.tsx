    ...
    <footer className="bg-gray-800 text-gray-300">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/daily-tours" className="hover:text-white transition-colors">Daily Tours</Link></li>
              ...
              <li className="pt-2 border-t border-gray-700">
                <Link href="/agent/login" className="text-primary-400 hover:text-primary-300 transition-colors font-medium flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/destinations/istanbul" className="hover:text-white transition-colors">Istanbul</Link></li>
              <li><Link href="/destinations/cappadocia" className="hover:text-white transition-colors">Cappadocia</Link></li>
              <li><Link href="/destinations/ephesus" className="hover:text-white transition-colors">Ephesus</Link></li>
              <li><Link href="/destinations/pamukkale" className="hover:text-white transition-colors">Pamukkale</Link></li>
              <li><Link href="/destinations/kusadasi" className="hover:text-white transition-colors">Kusadasi</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@funnytourism.com" className="hover:text-white transition-colors">info@funnytourism.com</a>
              </li>
              <li className="flex items-center">
                <svg className="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="https://wa.me/905395025310" className="hover:text-white transition-colors">WhatsApp: +90 539 502 53 10</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          ...
          <p className="mt-2">
            <Link href="/admin/dashboard" className="text-gray-600 hover:text-gray-400 transition-colors text-xs">
              Portal
            </Link>
          </p>
        </div>
