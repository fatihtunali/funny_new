    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.logo}>Funny Tourism</Text>
          <Text style={styles.subtitle}>Your Personalized Turkey Itinerary</Text>
          <View style={styles.companyInfo}>
            <Text style={{ fontSize: 10, color: '#4B5563', marginTop: 8 }}>
              Licensed Turkish Tour Operator - TURSAB Member
            </Text>
            <Text style={{ fontSize: 8, color: '#6B7280', marginTop: 2 }}>
              info@funnytourism.com • +90 532 585 8786
            </Text>
        ...
        {itinerary.customer_name && (
          <View style={{ marginBottom: 20, padding: 12, backgroundColor: '#FEF3C7', borderRadius: 8 }}>
        ...
        {itinerary.price_per_person && (
          <View style={styles.pricingSummary} wrap={false}>
            ...
            {itinerary.total_price && (
              <Text style={{ fontSize: 11, color: '#1F2937', textAlign: 'center', marginTop: 4, fontWeight: 'bold' }}>
                Total Trip Price: €{parseFloat(itinerary.total_price).toFixed(2)}
              </Text>
            )}
          </View>
        )}
        ...
        <View style={styles.footer} fixed>
          <View>
            <Text style={styles.footerBrand}>Funny Tourism</Text>
            <Text style={styles.footerText}>funnytourism.com</Text>
          </View>
          <Text
