...
export default function ItineraryPage() {
  ...
  const fetchItinerary = async () => {
    try {
      const response = await fetch(`/api/itinerary/${uuid}`);
  ...
  const handleBookingRequest = async () => {
    ...
    try {
      const response = await fetch(`/api/itinerary/${uuid}/request-booking`, {
        method: 'POST',
        headers: {
  ...
  const removeMealCodes = (title: string) => {
    // Remove meal codes like (B), (L), (D), (B/L), etc. from the end of titles
      ...
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <button
            type="button"
            onClick={() => router.back()}
            className="flex items-center gap-2 text-white/90 hover:text-white transition-colors mb-6 group cursor-pointer relative z-10"
          >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white">
                        {removeMealCodes(day.title || `Day ${day.day_number}`)}
                      </h3>
              ...
              <>
                ...
                <div className="bg-blue-50 rounded-lg p-4 mb-6">
                  <p className="text-gray-700 mb-3">
                    <strong>{itinerary.customer_name}</strong>, thank you for choosing <strong>{destination}</strong>!
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">info@funnytourism.com</div>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">+90 532 585 8786</div>
                    </div>
                  </a>
                  <a
